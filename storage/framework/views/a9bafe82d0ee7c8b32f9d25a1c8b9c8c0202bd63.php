            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="/cours/modifier/<?php echo e($cours->id); ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="auteur" name="auteur"
                                           value="<?php echo e($cours->auteur); ?>" placeholder="Enter de l'auteur">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="theme" name="theme"
                                           value="<?php echo e($cours->theme); ?>" placeholder="Donner le théme du cours">
                                </div>
                            </div>
                            <div class="form-group">
